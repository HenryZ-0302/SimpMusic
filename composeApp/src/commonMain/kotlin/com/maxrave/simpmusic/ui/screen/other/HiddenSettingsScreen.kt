...
fun HiddenSettingsScreen(
    ...
    // 直接从 DataStoreManager 读取，确保状态同步
    val enableLiquidGlassValue by sharedViewModel.getEnableLiquidGlass()
        .collectAsStateWithLifecycle(DataStoreManager.FALSE)
    val enableLiquidGlass = enableLiquidGlassValue == DataStoreManager.TRUE
    ...
    Column(
        ...
        if (getPlatform() == Platform.Android) {
            SettingItem(
                ...
                smallSubtitle = true,
                switch = (enableLiquidGlass to { enabled ->
                    sharedViewModel.setEnableLiquidGlass(enabled)
                }),
            )
        }
